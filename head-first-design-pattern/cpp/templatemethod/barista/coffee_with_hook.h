/*!
 * \file coffee_with_hook.h
 * \brief The Coffee_With_Hook class implementation.
...
class Coffee_With_Hook : public Caffeiner_Beverage_With_Hook
{
public:
	Coffee_With_Hook();
	virtual ~Coffee_With_Hook();
