/*
 * \file app_ui.c
 * \brief ui implement for cd application
...
static void announce(void)
{
	printf("\n\nWelcome to demonstration CD catalog database \
			program\n");
}
...
/* deleting all the tracks for a catalog */
static void del_track_entries(const cdc_entry *entry_to_delete)
{
	int track_no = 1;
	int delete_ok;
...
/* removes a trailing linefeed character from a string */
static void strip_return(char *string_to_strip)
{
	int len;
