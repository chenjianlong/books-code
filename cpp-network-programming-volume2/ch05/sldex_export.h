...
// Set SLDEX_NTRACE = 0 to turn on library specific tracing even if
// tracing is turned off for ACE.
#if !defined (SLDEX_NTRACE)
#  if (ACE_NTRACE == 1)
#    define SLDEX_NTRACE 1
#  else /* (ACE_NTRACE == 1) */
#    define SLDEX_NTRACE 0
#  endif /* (ACE_NTRACE == 1) */
#endif /* !SLDEX_NTRACE */

#if (SLDEX_NTRACE == 1)
#  define SLDEX_TRACE(X)
#else /* (SLDEX_NTRACE == 1) */
#  if !defined (ACE_HAS_TRACE)
#    define ACE_HAS_TRACE
#  endif /* ACE_HAS_TRACE */
#  define SLDEX_TRACE(X) ACE_TRACE_IMPL(X)
#  include "ace/Trace.h"
#endif /* (SLDEX_NTRACE == 1) */
